...
function getUserModelInfo(json) {
	return copyValues(json, ["FirstName", "LastName", "EmailAddress", "FacebookID", "Gender", "ShouldSendPushNotifications", "ShouldSendEmailNotifications", "Birthday", "DeviceToken", "Title"], ["FirstName", "LastName"]);
}
// -------------------------------
