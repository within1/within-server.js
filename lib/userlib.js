...
function getUserModelInfo(json) {
	return copyValues(json, ["FirstName", "LastName", "EmailAddress", "FacebookID", "Gender", "ShouldSendPushNotification", "ShouldSendEmailNotifications", "Birthday", "DeviceToken"], ["FirstName", "LastName"]);
}
// -------------------------------
...
function UpdateUserActivityAndNotifications(userid) {
	...
	.then(function(cuser) { return notif.UpdateInactivityEmail(cuser); })
...
function createNewUser(req) {
	...
	.then(function() { return notif.SendEmailNotification(usermodel, (new Date()), 0, notif.emailTypes["TypeEmailWelcomeToWithin"], "","","","");  })
	// Create Incomplete Onboarding Email Notification
	.then(function() { return notif.SendEmailNotification(usermodel, (new Date()), 24, notif.emailTypes["TypeEmailIncompleteOnboarding"], "","","","");  })
	// update activity
